...
import { congratulationHead, luckyarrow, luckyWheelInner, oopsHead, rewardImages, spinBtn } from "../../utils/images";
  ...
  return (
    <>
      <div className="luckyWheel-Game d-flex fd-column al-center jc-center gap-3">
        <div className="luckyWheel-Game-wheel p-rel">
          <div className="wheel">
            <div className="image-container d-flex al-center jc-center">
              <img className="p-abs w-6vw" style={{ top: "0vw", zIndex: "1" }} src={luckyarrow} alt="" />
              <img
                src={luckyWheelInner}
                alt="Spin the Wheel"
        ...
        <button disabled={disable} onClick={handleSpin} className="luckyWheel-Game-spin-btn">
            ...
            {alertpopup?.map((item, i) => (
              ...
              >
                ...
                <div className="content m-auto p-abs d-flex al-center jc-center" style={{ marginTop: "0vw" }}>
                  <div className="body-text d-flex al-center jc-center fd-column" style={{ fontSize: "4vw" }}>
                    {item.data}
                  </div>
                </div>
